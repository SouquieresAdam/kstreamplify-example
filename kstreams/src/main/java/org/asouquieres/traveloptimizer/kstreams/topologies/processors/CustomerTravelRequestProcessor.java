...
import org.asouquieres.traveloptimizer.kstreams.topologies.businessrules.EventManagement;
...
public class CustomerTravelRequestProcessor extends ContextualProcessor<String, CustomerTravelRequest, String, TravelAlert> {
    ...
    public void process(Record<String, CustomerTravelRequest> record) {
        EventManagement.whenACustomerRequestArose(record.value(), lastRequestAlertStateStore, availableConnectionStateStore, earlyRequestStateStore)
