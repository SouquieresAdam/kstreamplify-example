package org.asouquieres.traveloptimizer.kstreams.topologies;
...
import org.asouquieres.traveloptimizer.kstreams.TravelOptimizerStream;
import org.asouquieres.traveloptimizer.kstreams.TravelOptimizerTopics;
...
class TravelOptimizerTopologySupplierTest extends KafkaStreamsStarterTest {
    ...
    public void setup() {
        ...
        */
        ...
        trainTimeTableUpdateInputTopic = createInputTestTopic(TravelOptimizerTopics.trainUpdate());

        planeTimeTableUpdateInputTopic = createInputTestTopic(TravelOptimizerTopics.planeUpdate());

        customerTravelRequestInputTopic = createInputTestTopic(TravelOptimizerTopics.customerRequests());

        departureInputTopic = createInputTestTopic(TravelOptimizerTopics.departure());

        travelAlertOutputTopic = createOutputTestTopic(TravelOptimizerTopics.travelAlert());
    }
    ...
    protected KafkaStreamsStarter getKafkaStreamsStarter() {
        return new TravelOptimizerStream();
    }
}